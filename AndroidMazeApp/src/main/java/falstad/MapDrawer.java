...
public class MapDrawer extends DefaultViewer implements Serializable{
     ...
     * @param mazeh TODO
     */
    public MapDrawer(int width, int height, int map_unit, int step_size, Cells mazecells, Cells seencells, int map_scale, int[][] mazedists, int mazew, int mazeh, MazeController maze){
        view_width = width ;
        view_height = height ;
